     ...
     SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/task/retrieve/all").hasRole("ADMIN")
                		.requestMatchers("/task/retrieve/id/{taskId}").hasRole("ADMIN")
                		.requestMatchers("/task/update/status/{taskId}").hasRole("ADMIN")
                		.requestMatchers("/task/delete/id/{taskId}").hasRole("ADMIN")
